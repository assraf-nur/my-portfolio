...
const note = () => {
    return (
        <div>
            ...
            <div data-aos="fade-right" class="card lg:card-side bg-base-100 shadow-xl mt-12 text-white container mx-auto">
            ...
            <div data-aos="fade-left" class="card lg:card-side bg-base-100 shadow-xl mt-12 text-white container mx-auto">
            ...
            <div data-aos="fade-up-right" class="card lg:card-side bg-base-100 shadow-xl mt-12 text-white container mx-auto">
